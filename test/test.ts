...
describe('Wallets', () => {
    ...
    describe('Wallet Creation', async () => {
        const result = await Address.fromEntropy(testAddress, 'english');
    ...
    describe('Prefix Detection', () => {
        ...
        it('encodes an existing address with an alternate prefix', async () => {
            ...
            const newAthenaAddress = await Address.fromPublicKeys(newAddress.spend.publicKey, newAddress.view.publicKey, undefined, athenaPrefix.decimal);
            const newAthenaAddressByKey = await Address.fromKeys(newAddress.spend.privateKey, newAddress.view.privateKey, athenaPrefix.decimal);
...
describe('SubWallets', async () => {
    const baseWallet = await Address.fromSeed('dd0c02d3202634821b4d9d91b63d919725f5c3e97e803f3512e52fb0dc2aab0c');
    const subWallets = [
...
describe('Transactions', async function () {
    ...
    describe('Create Transaction Outputs', async () => {
        it('Amount: 1234567', async () => {
            ...
            const transfers = await cnUtil.generateTransactionOutputs('TRTLv3nzumGSpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzQjvRqX', amount);
    ...
    describe('Output Discovery', async () => {
        ...
        const derivation = await TurtleCoinCrypto.generateKeyDerivation(txPublicKey, walletPrivateViewKey);
        const ourOutputIndex = 2;

        it('underive public spend key (no match)', async () => {
            const publicSpendKey1 = await TurtleCoinCrypto.underivePublicKey(derivation, 0, 'aae1b90b4d0a7debb417d91b7f7aa8fdfd80c42ebc6757e1449fd1618a5a3ff1');
            assert(publicSpendKey1 !== walletPublicSpendKey);
        });

        it('underive public spend key (match)', async () => {
            const publicSpendKey2 = await TurtleCoinCrypto.underivePublicKey(derivation, ourOutputIndex, 'bb55bef919d1c9f74b5b52a8a6995a1dc4af4c0bb8824f5dc889012bc748173d');
    ...
    describe('Creation', () => {
        ...
        it('generate a fusion transaction', async function () {
            const madeOutputs = await cnUtil.generateTransactionOutputs('TRTLv3nzumGSpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzQjvRqX', 13080);
            const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94';
            const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909';
            const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b';
            const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418';
        ...
        it('generate a transaction using integrated address', async function () {
            const paymentId = '1886db9573ae180e27f39cced773bdf83aa3a55f1168d89e82bf337bb5373506';
            const madeOutputs = await cnUtil.generateTransactionOutputs('TRTLuxjc5auCRCJ9dUVPzt9EVTdT8GwogAaXBVFiTzbUC5sTZZaueftBubfuHB6C2BCQpKNjQDAdB9ZhsjZMndwc9ZnDBrCj846SpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzPs6LiD', 90);
            const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94';
            const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909';
            const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b';
            const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418';
        ...
        it('fail to generate a fusion transaction when not enough outputs are created', async function () {
            const madeOutputs = await cnUtil.generateTransactionOutputs('TRTLv3nzumGSpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzQjvRqX', 12000);
            const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94';
            const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909';
            const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b';
            const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418';
        ...
        it('fail to generate transaction using two destinations with differing payment IDs', async function () {
            const madeOutputs = await cnUtil.generateTransactionOutputs('TRTLuxjc5auCRCJ9dUVPzt9EVTdT8GwogAaXBVFiTzbUC5sTZZaueftBubfuHB6C2BCQpKNjQDAdB9ZhsjZMndwc9ZnDBrCj846SpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzPs6LiD', 90);
            const madeOutputs2 = await cnUtil.generateTransactionOutputs('TRTLuxp8RkjA5TMvFWhSoz94bwe9fHbFpCb1f669XiNc95D7s7CShfW9unmPq2M3nS9jbdbx37dnH9unntNPGVmqA5LbzVL4HQrSpRsZWxkcbDhiVEfy9rAgX3X9b7z8XQAy9gwjB6cwr6BJ3P52a6TQUSfA4eXf3Avwz7W89J4doLuigLjUzPembYH', 90);
            const txPublicKey = '3b0cc2b066812e6b9fcc42a797dc3c723a7344b604fd4be0b22e06254ff57f94';
            const walletPrivateViewKey = '6968a0b8f744ec4b8cea5ec124a1b4bd1626a2e6f31e999f8adbab52c4dfa909';
            const walletPrivateSpendKey = 'd9d555a892a85f64916cae1a168bd3f7f400b6471c7b12b438b599601298210b';
            const walletPublicSpendKey = '854a637b2863af9e8e8216eb2382f3d16616b3ac3e53d0976fbd6f8da6c56418';
...
describe('Blocks', async function () {
    ...
    describe('Structures', async () => {
        ...
        it('merges blocks', async () => {
            ...
            assert(await mergedBlobResult.toString() === expectedMergedBlob);
        });
        ...
        it('handles block miner transaction with malformed TX_EXTRA data', async () => {
            const a = await Block.from('');
