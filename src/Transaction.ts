...
export class Transaction {
    ...
    public async generateTxProofOfWork() {
        ...
        try {
            ...
            const nonce = TurtleCoinCrypto.generateTransactionPow(prefix, unserializedOffset, 20000);
    ...
    public async generateTxProofOfWorkFusion() {
        if (this.readonly) {
            throw new Error('Transaction is read-only');
        }
        ...
        try {
            ...
            const nonce = TurtleCoinCrypto.generateTransactionPow(prefix, unserializedOffset, 60000);
            ...
            throw new Error('Can not TurtleCoinCrypto.generateTransactionPowFusion()');
        }
    }
