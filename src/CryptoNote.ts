...
export class CryptoNote implements ICryptoNote {
    ...
    public async createTransactionStructure (
        ...
        {
            const factored_out = this.m_config.MultiplierTransactionPoWDifficultyFactoredOutV1 || Config.MultiplierTransactionPoWDifficultyFactoredOutV1;
            const based_diff = this.m_config.TransactionPoWDifficultyDynV1 || Config.TransactionPoWDifficultyDynV1;
            const per_io_diff = this.m_config.MultiplierTransactionPoWDifficultyPerIOV1 || Config.MultiplierTransactionPoWDifficultyPerIOV1;
            diff = based_diff + (transactionInputs.length + transactionOutputs.outputs.length * factored_out) * per_io_diff;
        }
