...
export class CryptoNote {
    ...
    public async createTransactionStructure(
        ...
        let diff = this.config.TransactionPowDifficulty || Config.TransactionPowDifficulty;
        ...
        if (feeAmount === 0) {
            ...
            diff = this.config.FusionTransactionPowDifficulty || Config.FusionTransactionPowDifficulty;
        }
        ...
        try {
            ...
            throw new Error('Can not generateTxProofOfWork() for diff: ' + diff + ' ' + error);
        }
